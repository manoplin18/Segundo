...
class Empresa{     
    ...
    int nmaxcon;         //para saber cuántos caben en array Contratos                           
    ...
    protected:         //métodos auxiliares usados por los métodos públicos     
        ...
        int altaContrato(Contrato *c);     //añade el contrato apuntado por c al array contratos
                                          //devuelve la posición donde lo mete (-1 si no cabe)
    public:
        Empresa();  
        virtual ~Empresa();    
        ...
        int nContratosTP() const;              //Devuelve el numero de Contratos que son Tarifa Plana 
